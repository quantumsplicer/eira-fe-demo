...
const PaymentLinkDialog = ({
  ...
  return (
    ...
    //     //     disablePortal: true,
    //     //     BackdropProps: {
    //     //       style: { backgroundColor: "rgba(0, 0, 0, 0)" }, // Fully transparent backdrop
    //     //     },
    //     //   }}
    //     //   PaperProps={{
    //     //     sx: {
    ...
    //     //   sx={{
    //     //     "& .MuiPaper-root": {
    //     //       boxShadow: "none", // Removes the shadow from the drawer
    //     //     },
    //     //   }}
    //     // >
    //     //   <IconButton
    ...
    //     //     <Stack sx={{ pl: 4, pr: 4, pt: 10 }} spacing={7} alignSelf="center">
    //     //       <Stack justifyContent="center" alignItems="center" sx={{ pt: 0 }}>
    ...
    //     //         </Typography>
    //     //       </Stack>
    //     //       <Stack spacing={4} sx={{ p: 1 }} alignContent="center">
    //     //         <Controller
    //     //           name="phoneNumber"
    //     //           control={control}
    //     //           rules={{
    ...
    //     //       </Stack>
    //     //     </Stack>
    //     //     <Box sx={{ p: 4 }} width="90%" alignSelf="center">
    //     //       <Stack spacing={2}>
    //     //         <Stack spacing={2}>
    //     //           <FormGroup sx={{ fontSize: 10 }}>
    //     //             <FormControlLabel
    ...
    //     //                   lineHeight={1.3}
    //     //                 >
    //     //                   I confirm that all these sessions were conducted
    //     //                   through Eira and the payment link generated here is
