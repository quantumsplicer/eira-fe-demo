...
const StudentSignInMobile = () => {
    ...
    const [isOtpVerificationDone, setIsOtpVerificationDone] = useState<boolean>(false);
    ...
    const handleContinueClick = () => {
        isExistingUser ? navigate("/pay/create-session") : navigate("/student/signUp")
    }
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <Button
                    disabled={phone.length !== 10 || !isPhoneNumberValid()}
                        ...
                        (
                            isOtpVerificationDone ?
                                <StatusDrawer
                                    ...
                                    type="success"
                                    headingMessage={isExistingUser ? "Welcome Back, Maanav" : "Login Successful"}
                                    subHeadingMessage1={isExistingUser ? "Start making your tuition payments now" : "Complete your onboarding to start making payments"}
                                ...
                                >
                                    ...
                                    >
                                        <OTPInput
                                            phoneNumber={phone}
                                            onSubmit={() => setIsOtpVerificationDone(true)}
                                            isDrawer={true}
                                        />
                                    </Stack>
                                </Drawer>
